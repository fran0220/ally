  ...
  return (
    <div className="relative group">
      ...
      >
        ...
        <span
          className={`absolute bottom-1.5 left-1/2 -translate-x-1/2 h-[3px] rounded-full transition-all duration-300 ease-out
            ${active
        ...
        {status === 'ready' && !disabled && (
          <span
            className={`absolute top-2 right-2 w-1.5 h-1.5 rounded-full transition-colors
    ...
    <nav className="fixed top-20 left-1/2 -translate-x-1/2 z-50 animate-fadeInDown">
      <div
        ...
        style={{
          ...
          boxShadow:
            '0 8px 32px rgba(0,0,0,0.06), 0 1.5px 6px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.7)',
        }}
      >
        {items.map((item) => (
          <NavItem
  ...
  return (
    <div className="fixed top-20 left-6 z-[60]" ref={menuRef}>
      ...
      >
        ...
        <AppIcon
          name="chevronDown"
          className={`w-4 h-4 text-[var(--glass-text-tertiary)] transition-transform ${isOpen ? 'rotate-180' : ''}`}
        />
      </button>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-[var(--glass-text-primary)] text-sm truncate">
                        {ep.title}
                      </div>
                      {ep.summary && (
