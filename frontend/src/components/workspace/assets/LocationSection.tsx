        ...
        <div className="glass-surface p-6">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    <span className="inline-flex h-9 w-9 items-center justify-center rounded-[var(--glass-radius-lg)] bg-[var(--glass-tone-info-bg)] text-[var(--glass-tone-info-fg)]">
                ...
                {locations.map(location => (
                    <LocationCard
                        ...
                        onRegenerate={() => {
                            ...
                            // 单图：重新生成单张
                            if (validImages.length === 1 && firstValidImage) {
                                const imageIndex = firstValidImage.imageIndex
