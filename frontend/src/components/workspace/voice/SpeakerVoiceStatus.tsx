            ...
            <div className="glass-surface px-4 py-3 mb-3 mx-4">
                ...
                <div className="flex flex-wrap gap-2">
                    {speakers.map(speaker => {
                        ...
                        const count = speakerStats[speaker] ?? 0
                        const hasCharacter = hasSpeakerCharacter ? hasSpeakerCharacter(speaker) : true
                        return (
                            <div
                                key={speaker}
                                className="w-full sm:w-[280px] max-w-full flex items-center gap-1.5 rounded-[var(--glass-radius-lg)] border border-[var(--glass-stroke-base)] bg-[var(--glass-bg-surface-strong)] px-3 py-2"
                            >
        ...
        <div className="glass-surface p-5">
            ...
            <div className="flex flex-wrap gap-2">
                {speakers.map(speaker => {
                    ...
                    return (
                        <div key={speaker} className="w-full sm:w-[280px] max-w-full flex items-center gap-1.5 px-3 py-2 rounded-[var(--glass-radius-lg)] border border-[var(--glass-stroke-base)] bg-[var(--glass-bg-surface-strong)]">
                            <div className="min-w-0">
