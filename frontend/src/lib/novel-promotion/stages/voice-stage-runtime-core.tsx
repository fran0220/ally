...
import VoiceLineList from '@/components/workspace/voice-stage/VoiceLineList'
import VoiceControlPanel from '@/components/workspace/voice-stage/VoiceControlPanel'
import SpeakerVoiceBindingDialog from '@/components/workspace/voice/SpeakerVoiceBindingDialog'
