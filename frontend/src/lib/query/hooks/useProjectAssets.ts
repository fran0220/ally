...
export function useProjectAssets(projectId: string | null) {
    const assetsQuery = useQuery({
        ...
        queryFn: async () => {
            ...
            const res = await fetchWithAuth(`/api/novel-promotion/${projectId}/assets`)
...
export function useProjectCharacters(projectId: string | null) {
    return useQuery({
        ...
        queryFn: async () => {
            if (!projectId) throw new Error('Project ID is required')
            const res = await fetchWithAuth(`/api/novel-promotion/${projectId}/characters`)
...
export function useProjectLocations(projectId: string | null) {
    return useQuery({
        ...
        queryFn: async () => {
            if (!projectId) throw new Error('Project ID is required')
            const res = await fetchWithAuth(`/api/novel-promotion/${projectId}/locations`)
