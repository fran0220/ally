...
export function useStoryboards(episodeId: string | null) {
    return useQuery({
        ...
        queryFn: async () => {
            ...
            const res = await fetchWithAuth(`/api/novel-promotion/episodes/${episodeId}/storyboards`)
...
export function useModifyPanelImage(projectId: string | null, episodeId: string | null) {
    ...
    return useMutation({
        mutationFn: async (params: {
            ...
            if (!projectId) throw new Error('Project ID is required')
            const res = await fetchWithAuth(`/api/novel-promotion/${projectId}/modify-panel-image`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
export function useGenerateVideo(projectId: string | null, episodeId: string | null) {
    ...
    return useMutation({
        mutationFn: async (params: {
            ...
            const res = await fetchWithAuth(`/api/novel-promotion/${projectId}/generate-video`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
export function useSelectPanelCandidate(episodeId: string | null) {
    ...
    return useMutation({
        mutationFn: async ({ panelId, candidateId }: { panelId: string; candidateId: string }) => {
            const res = await fetchWithAuth(`/api/novel-promotion/panels/${panelId}/select-candidate`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
export function useLipSync(projectId: string | null, episodeId: string | null) {
    ...
    return useMutation({
        mutationFn: async (params: {
            ...
            const res = await fetchWithAuth(`/api/novel-promotion/${projectId}/lip-sync`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    storyboardId: params.storyboardId,
